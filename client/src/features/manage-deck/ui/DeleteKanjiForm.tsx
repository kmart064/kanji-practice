...
import { deleteKanji } from "@/features/manage-deck/api/deleteKanji";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-center">
        <button
          type="submit"
          className="px-8 btn-tinted btn-red text-white py-2 rounded-lg transition duration-150 shadow"
        >
          Delete
        </button>
      </div>
